...
worksheet1.write_column(1, 1, ref_abstract_list)
worksheet1.write_column(1, 2, ref_abstract_translation_list)
worksheet1.write_column(1, 3, ref_date_list)
worksheet1.write_column(1, 4, ref_journal_name_list)
worksheet1.write_column(1, 5, ref_impact_list)
worksheet1.write_column(1, 6, ref_doi_list)
...
worksheet2.write_column(1, 1, similar_abstract_list)
worksheet2.write_column(1, 2, similar_abstract_translation_list)
worksheet2.write_column(1, 3, similar_date_list)
worksheet2.write_column(1, 4, similar_journal_name_list)
worksheet2.write_column(1, 5, similar_impact_list)
worksheet2.write_column(1, 6, similar_doi_list)
