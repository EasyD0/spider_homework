...
Target_Url,Main_name,Key_words,Excel_Path,Main_Article,Requirement=input_info()
if Target_Url or Main_name:
    get_excel_from_urlname(url=Target_Url,name=Main_name,path=Excel_Path,requirement=Requirement)
else:
